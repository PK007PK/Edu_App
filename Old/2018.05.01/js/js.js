...
function resetMenu() {
	...
	document.querySelector('div.karta').innerHTML = '';
...
function sprawdzenie(sprawdzenie_arg) {
	...
	//var aud = document.getElementById('audio_karta');
...
function polang(polang_arg) {
	...
	let h1Element = document.createElement('h1'); 	
		h1Element.setAttribute('class', 'karta');
	...
	let inpElement = document.createElement('input');
		...
		inpElement.setAttribute('placeholder', 'tu wpisz w liczbie pojedynczej');
	...
	//*let audioElement = document.createElement('audio');												audioElement.setAttribute('class', 'karta'); 
		//*audioElement.setAttribute('id', 'audio_karta');
		//*audioElement.setAttribute('src', elements[randomElementNr].sound);					   
		//*audioElement.autostart = 'false';
	
		//*docFragment.appendChild(audioElement);
	
	let imgElement = document.createElement('img');	
		imgElement.setAttribute('class', 'karta'); 
	...
	document.getElementById('div_karta').appendChild(docFragment);					   
...
function checkInput (checkInput_arg) {
	...
	//*var aud = document.getElementById('audionr' + checkInput_arg );
...
function nauka() {
	...
	for (var i=0; i < loopMax; i++) {
		...
		//*	audioElement.setAttribute('id', 'audionr' + i);
		//*    audioElement.setAttribute('src', elements[i].sound);	
		//*	audioElement.setAttribute('autostart', 'false');
		//*	audioElement.setAttribute('height', '30');
